...
class AppStateNotifier extends ChangeNotifier {
  ...
  AqaumaticAppAuthUser? initialUser;
  AqaumaticAppAuthUser? user;
  ...
  void update(AqaumaticAppAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? CatalougePageWidget() : LoginPageWidget(),
          //appStateNotifier.loggedIn ? CatalougePageWidget() : SplashScreen(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          //builder: (context, params) => OrderListPage(),
        ),
        FFRoute(
          name: 'AboutPage',
          path: '/aboutPage',
        ...
        FFRoute(
          name: 'CatalougeListPage',
          path: '/catalougeListPage',
          builder: (context, params) => CatalougeListPageWidget(
        ...
        FFRoute(
          name: 'DownloadDetailsPage',
          path: '/downloadDetailsPage',
          builder: (context, params) => DownloadDetailsPageWidget(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/new-modern-steel-faucet-kitchen_1.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
